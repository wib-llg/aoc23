...
fn main() {
    ...
    // println!(
    //     "Day 3 Part 1: {}",
    //     day3_part1(read_input("data/day03_input1_test.txt").as_str())
    // );
    println!(
        "Day 3 Part 1: {}",
        day3_part1(read_input("data/day03_input1.txt").as_str())
    );
    // println!(
    //     "Day 2 Part 2: {}",
    //     day3_part2(read_input("data/day03_input2.txt").as_str())
    // );
}